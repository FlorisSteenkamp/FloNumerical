...
function eDiv(N, D, expansionLength) {
    ...
    let F = [1 / e_estimate_1.eEstimate(D_)]; // Initial guess - out by 1/2 upls
    let i = 1;
    ...
    //console.log('---------');
    while (true) {
        N_ = expansion_product_1.expansionProduct(N_, F);
        //console.log('N ', N_);
        ...
        if (i > expansionLength) {
            ...
            if (exact) {
                ...
                N_ = e_to_bitlength_1.eToBitlength(N_, resultBitlengthUpperBound);
        ...
        D_ = expansion_product_1.expansionProduct(D_, F);
        //console.log('D ', estimate(D));
        //console.log('D ', D_);
        F = e_diff_1.eDiff([2], D_);
        //console.log('F ', estimate(F));
        //console.log('F ', F);
        i *= 2;
    }
