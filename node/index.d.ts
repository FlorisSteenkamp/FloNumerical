...
export { expansionDiv, compress, estimate, expansionDiff, fastExpansionSum, fastTwoDiff, fastTwoSum, growExpansion, isAdjacent, isOverlapping, isNonOverlapping, isNonOverlappingAll, merge, negativeOf, orient2d, scaleExpansion, scaleExpansion2, eMultBy2, eMultByNeg2, eDivBy2, split, twoDiff, twoProduct, twoSum, reduceSignificand, expansionProduct, sign, exponent, significand, compare, abs, within, toBitlength, intPow, calculate, calculateSum, calculateProduct, parseDouble, parseDoubleDetailed, isBitAligned, msbExponent, lsbExponent, bitLength, expBitLength, binaryStringToDouble, doubleToBinaryString, doubleToOctets, octetsToDouble, getHighestSetBit, getLowestSetBit, isValid, qSqrt, toQuad, qAbs, qAddDouble, qAddQuad, qProduct, qSum, qCompare, qDiffQuad, qMultDouble1, qMultDouble2, qMultQuad, qDivDouble, qDivQuad, qNegativeOf, qSign, qMultBy2, qMultBy4, qDivBy2, qMultByNeg2, qMultByNeg4, qMin, qMax, qDivQuadWithError, divWithErr, sqrtWithErr, };
